...
- Pagination with 9 movies per page
...
3. Enter a rating from 0.0 to 10.0 and an optional comment
...
This project is for educational purposes. Movie data is provided by the OMDb API at https://www.omdbapi.com